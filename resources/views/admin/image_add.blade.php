...
<div class="col-md-12">
    <div class="ibox">
        ...
        <div class="ibox-body">
            <form role="form" action="{{route('admin_image_store',['arac_id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover" id="example-table" cellspacing="0" width="100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('admin_image_delete',['id'=> $rs->id,'arac_id'=>$data->id])}}" onclick="return confirm ('Silmek istediğinize emin misiniz?')"> Sil</a></td>
                    </tr>
                    @endforeach
                </tbody>
